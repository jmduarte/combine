...
protected:
  ...
  const std::vector<std::pair<RooNCSplineCore::T, RooNCSplineCore::T>> getPoints(
...
public:
  RooNCSplineFactory_1D(RooAbsReal& splineVar_,
                        TString appendName_ = "",
...
template void RooNCSplineFactory_1D::setPoints<Float_t>(const std::vector<Float_t>& XList,
                                                        const std::vector<Float_t>& FcnList);
template void RooNCSplineFactory_1D::setPoints<Double_t>(const std::vector<Double_t>& XList,
