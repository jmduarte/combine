...
public:
  ...
  RooParametricShapeBinPdf(const RooParametricShapeBinPdf& other, const char* name = 0);
...
private:
  virtual RooPlot* plotOn(RooPlot* frame,
                          ...
                          const RooCmdArg& arg10 = RooCmdArg::none()) const {
    return mypdf.arg().plotOn(frame, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
  }
  virtual RooPlot* plotOn(RooPlot* frame, RooLinkedList& cmdList) const { return mypdf.arg().plotOn(frame, cmdList); }
