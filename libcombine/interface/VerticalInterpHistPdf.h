...
public:
  ...
  VerticalInterpHistPdf(const char *name,
                        const char *title,
                        const RooRealVar &x,
...
private:
  ClassDef(VerticalInterpHistPdf, 1)  //
      ...
      protected : void setupCaches() const;
...
public:
  ...
  FastVerticalInterpHistPdfBase(const char *name,
                                const char *title,
                                const RooArgSet &obs,
                                const RooArgList &funcList,
                                const RooArgList &coefList,
...
public:
  ...
  FastVerticalInterpHistPdf(const char *name,
                            const char *title,
                            const RooRealVar &x,
                            const RooArgList &funcList,
                            const RooArgList &coefList,
...
public:
  FastVerticalInterpHistPdfV(const FastVerticalInterpHistPdf &,
...
public:
  ...
  FastVerticalInterpHistPdf2D(const char *name,
                              const char *title,
                              const RooRealVar &x,
                              const RooRealVar &y,
                              bool conditional,
...
public:
  ...
  FastVerticalInterpHistPdf2Base(const char *name,
                                 const char *title,
                                 const RooArgSet &obs,
...
public:
  ...
  FastVerticalInterpHistPdf2(const char *name,
                             const char *title,
                             const RooRealVar &x,
                             const TList &funcList,
                             const RooArgList &coefList,
...
public:
  FastVerticalInterpHistPdf2V(const FastVerticalInterpHistPdf2 &,
                              const RooAbsData &data,
                              bool includeZeroWeights = false);
  void fill(std::vector<Double_t> &out) const;
...
public:
  ...
  FastVerticalInterpHistPdf2D2(const char *name,
                               const char *title,
                               const RooRealVar &x,
                               const RooRealVar &y,
                               bool conditional,
...
public:
  ...
  /// If conditional = false, the pdf is normalized integrating on (x,y).
  /// If conditional = true, the pdf is separately normalized integrating on (y) for each specific (x) bin
  FastVerticalInterpHistPdf3D(const char *name,
                              const char *title,
                              const RooRealVar &x,
                              const RooRealVar &y,
                              const RooRealVar &z,
