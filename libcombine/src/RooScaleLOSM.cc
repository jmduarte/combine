...
RooScaleLOSM::RooScaleLOSM(const char *name, const char *title, RooAbsReal &mH)
    : RooAbsReal(name, title), mH_("mH", "Higgs boson mass [GeV]", this, mH) {}
...
ClassImp(RooScaleLOSM)
    ...
    ////////////////////////////////////////////////////////////////////
    RooScaleHGamGamLOSM::RooScaleHGamGamLOSM(const char *name,
                                             const char *title,
                                             RooAbsReal &mH,
                                             RooAbsReal &ct,
                                             RooAbsReal &cW,
...
TObject *RooScaleHGamGamLOSM::clone(const char *newname) const {
  return new RooScaleHGamGamLOSM(newname,
                                 this->GetTitle(),
...
ClassImp(RooScaleHGamGamLOSM)
    ...
    ////////////////////////////////////////////////////////////////////
    RooScaleHGluGluLOSM::RooScaleHGluGluLOSM(
        const char *name, const char *title, RooAbsReal &mH, RooAbsReal &ct, RooAbsReal &mb, RooAbsReal &cb)
    : RooScaleLOSM(name, title, mH),
      ct_("ct", "Top Quark coupling constant", this, ct),
      mb_("mb", "(Running) Bottom Quark mass [GeV]", this, mb),
      cb_("cb", "Bottom Quark coupling constant", this, cb) {
...
TObject *RooScaleHGluGluLOSM::clone(const char *newname) const {
  return new RooScaleHGluGluLOSM(newname,
                                 this->GetTitle(),
                                 const_cast<RooAbsReal &>(mH_.arg()),
                                 const_cast<RooAbsReal &>(ct_.arg()),
                                 const_cast<RooAbsReal &>(mb_.arg()),
...
ClassImp(RooScaleHGluGluLOSM)
    ...
    ////////////////////////////////////////////////////////////////////
    RooScaleHGamGamLOSMPlusX::RooScaleHGamGamLOSMPlusX(const char *name,
                                                       const char *title,
                                                       RooAbsReal &mH,
                                                       RooAbsReal &ct,
                                                       RooAbsReal &cW,
                                                       ...
                                                       RooAbsReal &cb,
                                                       RooAbsReal &X)
    : RooScaleHGamGamLOSM(name, title, mH, ct, cW, mb, cb), X_("X", "Extra amplitude in the photon loop", this, X) {}

TObject *RooScaleHGamGamLOSMPlusX::clone(const char *newname) const {
  return new RooScaleHGamGamLOSMPlusX(newname,
                                      this->GetTitle(),
                                      const_cast<RooAbsReal &>(mH_.arg()),
                                      const_cast<RooAbsReal &>(ct_.arg()),
                                      const_cast<RooAbsReal &>(cW_.arg()),
...
ClassImp(RooScaleHGamGamLOSMPlusX)
    ...
    ////////////////////////////////////////////////////////////////////
    RooScaleHGluGluLOSMPlusX::RooScaleHGluGluLOSMPlusX(const char *name,
                                                       const char *title,
                                                       RooAbsReal &mH,
                                                       RooAbsReal &ct,
                                                       RooAbsReal &mb,
                                                       RooAbsReal &cb,
                                                       RooAbsReal &X)
    : RooScaleHGluGluLOSM(name, title, mH, ct, mb, cb), X_("X", "Extra amplitude in the gluon loop", this, X) {}

TObject *RooScaleHGluGluLOSMPlusX::clone(const char *newname) const {
  return new RooScaleHGluGluLOSMPlusX(newname,
                                      this->GetTitle(),
                                      const_cast<RooAbsReal &>(mH_.arg()),
                                      const_cast<RooAbsReal &>(ct_.arg()),
                                      const_cast<RooAbsReal &>(mb_.arg()),
