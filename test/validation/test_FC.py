...
M = "FeldmanCousins"
suite += [
    (M, "*", MultiDatacardTest("Counting", datacardGlob("simple-counting/counting-B5p5-Obs[16]*-Syst30U.txt"), M, ""))
]
suite += [
    (
        M,
        "*",
        MultiDatacardTest(
            "Counting_Lower", datacardGlob("simple-counting/counting-B5p5-Obs[12][10]-Syst30U.txt"), M, "--lowerLimit"
        ),
    )
]
...
suite += [
    (
        M,
        "*",
        MultiDatacardTest("Counting_ZeroB_Lower", datacardGlob("simple-counting/counting-B0-*.txt"), M, "--lowerLimit"),
    )
]
