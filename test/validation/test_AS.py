...
suite += [
    (
        M,
        "*",
        MultiDatacardWithExpectedTest("Counting", datacardGlob("simple-counting/counting-B5p5-Obs[16]*.txt"), M, ""),
    )
]
...
suite += [
    (M, "summer11", SingleDatacardWithExpectedTest("Summer11_HWWS_130", "summer11/hwws.130/comb_hww.txt", M, "", 130))
]
suite += [
    (
        M,
...
suite += [
    (M, "summer11", SingleDatacardWithExpectedTest("Summer11_HTT_125", "summer11/htt.125/comb_htt.txt", M, "", 125))
]
