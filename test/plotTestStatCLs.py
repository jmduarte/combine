...
parser.add_option(
    "-I", "--invert", default=False, action="store_true", help="Invert Alt for Null in Plotting (+ numbers)"
)
...
parser.add_option(
    "-P", "--Print", default=False, action="store_true", help="Just print the toys directory to see whats there"
)
parser.add_option(
    "-E", "--expected", default=False, action="store_true", help="Replace observation with expected (under alt hyp)"
)
parser.add_option(
    "-q",
    "--quantileExpected",
...
parser.add_option(
    "", "--signif", action="store_true", default=False, help="If significance, don't plot CLs+b, i.e make the q0 plot"
)
