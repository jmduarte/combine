...
void testFastHistPdf(VerticalInterpHistPdf &slow,
                     FastVerticalInterpHistPdf &fast,
                     RooAbsData &data,
                     RooAbsData &nuisdata) {
...
template <typename PdfT> double testPerformances(PdfT &pdf, RooAbsData &data, RooAbsData &nuisdata) {
