...
private:
  ...
  enum WorkingMode { Plain = 1, FastPlain = 2, Sorted = 11, FastSorted = 12, PreSort = 21, FastPreSort = 22 } mode_;
  inline bool hasPreSort() const { return mode_ == PreSort || mode_ == FastPreSort; }
  inline bool hasSort() const {
    return mode_ == Sorted || mode_ == FastSorted || mode_ == PreSort || mode_ == FastPreSort;
  }
