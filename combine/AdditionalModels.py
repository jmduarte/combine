    ...
    def setup(self):
        ...
        if not self.doHZg:
            ...
            self.modelBuilder.factory_(
                'expr::c8_Gscal_gamma("@0*@0 *@1+@2*@2*@3", kgamma, SM_BR_hgg, kZgamma, SM_BR_hzg)'
            )
...
class CWidth(SMLikeHiggsModel):
    ...
    def setup(self):
        ...
        if not self.doHZg:
            ...
            self.modelBuilder.factory_(
                'expr::c7_Gscal_gamma("@0*@0 *@1+@2*@2*@3", kgamma, SM_BR_hgg, kZgamma, SM_BR_hzg)'
            )
...
class TwoHDM(SMLikeHiggsModel):
        ...
        for po in physOptions:
            ...
            if po.startswith("thdmtype="):
                ...
                if len(self.thdmtype) != 1:
                    ...
                    int(self.thdmtype[0]) != 1
                    and int(self.thdmtype[0]) != 2
                    and int(self.thdmtype[0]) != 3
                    and int(self.thdmtype[0]) != 4
                ):
    ...
    def setup(self):
        ...
        self.productionScaling = {"ttH": "ku", "qqH": "kV", "WH": "kV", "ZH": "kV", "VH": "kV"}
