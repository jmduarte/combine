...
public:
  RooChebyshevPDF(){};
  RooChebyshevPDF(const char* name, const char* title, RooAbsReal& var, RooArgList& coefList);
  RooChebyshevPDF(const RooChebyshevPDF& other, const char* name = 0);
  virtual TObject* clone(const char* newname) const { return new RooChebyshevPDF(*this, newname); }
...
public:
  RooErfPdf(){};
  RooErfPdf(
      const char* name, const char* title, RooAbsReal& _x, RooAbsReal& _turnOn, RooAbsReal& _width, int _onOff = 1);
...
public:
  RooPowerExpPdf(){};
  RooPowerExpPdf(const char* name, const char* title, RooAbsReal& _x, RooAbsReal& _c, RooAbsReal& _power);
...
public:
  RooTH1DPdf(){};
  RooTH1DPdf(const char* name, const char* title, RooAbsReal& _x, TH1D& _hist, bool _interpolate = false);
...
public:
  RooPowerFunction(){};
  RooPowerFunction(const char* name, const char* title, RooAbsReal& _x, RooAbsReal& _r);
...
public:
  RooPowerLaw(){};
  RooPowerLaw(const char* name, const char* title, RooAbsReal& _x, RooAbsReal& _power);
  ...
  Int_t getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& anVars, const char* rangeName = 0) const;
  Double_t analyticalIntegral(Int_t code, const char* rangeName = 0) const;
...
public:
  RooExpPoly(){};
  RooExpPoly(const char* name, const char* title, RooAbsReal& _x, RooArgList& _coefs);
