...
public:
  RooVBFZZPdf_v2(){};
  RooVBFZZPdf_v2(const char* name,
                 const char* title,
                 RooAbsReal& _m4l,
                 RooAbsReal& _a4,
                 RooAbsReal& _a5,
...
public:
  RooBetaFunc_v2();
  RooBetaFunc_v2(const char* name,
                 const char* title,
                 RooAbsReal& _mZstar,
                 RooAbsReal& _mZ,
                 RooAbsReal& _m0,
...
public:
  ...
  RooRelBWUFParamWidth(const char* name, const char* title, RooAbsReal& _m4l, RooAbsReal& _mH, RooAbsReal& _width);
...
public:
  RooRelBWUFParam(){};
  RooRelBWUFParam(const char* name,
                  const char* title,
                  RooAbsReal& _m4l,
                  RooAbsReal& _mH,
...
public:
  RooRelBWHighMass(){};
  RooRelBWHighMass(const char* name, const char* title, RooAbsReal& _m4l, RooAbsReal& _mH, RooAbsReal& _gamma);
...
public:
  RooaDoubleCBxBW();
  RooaDoubleCBxBW(const char* name,
                  const char* title,
                  RooAbsReal& _x,
                  RooAbsReal& _shift,
                  RooAbsReal& _sigma,
...
public:
  RooCPSHighMassGGH();
  RooCPSHighMassGGH(const char* name,
                    const char* title,
                    RooAbsReal& _x,
                    RooAbsReal& _mH,
                    RooAbsReal& _KPrime,
...
public:
  RooBWHighMassGGH();
  RooBWHighMassGGH(const char* name,
                   const char* title,
                   RooAbsReal& _x,
                   RooAbsReal& _mH,
                   RooAbsReal& _KPrime,
...
public:
  ...
  RooCPSHighMassGGHNoInterf(const char* name,
                            const char* title,
                            RooAbsReal& _x,
                            RooAbsReal& _mH,
                            RooAbsReal& _KPrime,
...
public:
  RooCPSHighMassVBF();
  RooCPSHighMassVBF(const char* name,
                    const char* title,
                    RooAbsReal& _x,
                    RooAbsReal& _mH,
                    RooAbsReal& _KPrime,
...
public:
  ...
  RooCPSHighMassVBFNoInterf(const char* name,
                            const char* title,
                            RooAbsReal& _x,
                            RooAbsReal& _mH,
                            RooAbsReal& _KPrime,
