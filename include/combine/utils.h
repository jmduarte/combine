...
namespace utils {
  ...
  void factorizePdf(
      RooStats::ModelConfig &model, RooAbsPdf &pdf, RooArgList &obsTerms, RooArgList &constraints, bool debug = false);
  void factorizePdf(
      const RooArgSet &observables, RooAbsPdf &pdf, RooArgList &obsTerms, RooArgList &constraints, bool debug = false);
  ...
  void factorizeFunc(const RooArgSet &observables,
                     RooAbsReal &pdf,
                     RooArgList &obsTerms,
  ...
  void guessChannelMode(RooSimultaneous &simPdf, RooAbsData &simData, bool g_verbose = false);
  void setChannelGenModes(RooSimultaneous &simPdf, const std::string &binned, const std::string &unbinned, int g_verbose);

  /// set style for plots
  void tdrStyle();

  /// make plots, if possible
  std::vector<RooPlot *> makePlots(const RooAbsPdf &pdf,
  ...
  void createSnapshotFromString(const std::string expression,
                                const RooArgSet &allvars,
                                RooArgSet &output,
                                const char *context = "createSnapshotFromString");
