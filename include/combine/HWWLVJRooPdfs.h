...
public:
  ...
  Int_t getAnalyticalIntegral(RooArgSet& allVars,
                              RooArgSet& analVars,
                              const char* rangeName = 0) const;  // analytic integral
...
public:
  RooBWRunPdf(){};
  RooBWRunPdf(const char* name, const char* title, RooAbsReal& _x, RooAbsReal& _mean, RooAbsReal& _width);
...
public:
  RooAlpha4ErfPow2Pdf(){};
  RooAlpha4ErfPow2Pdf(const char* name,
                      const char* title,
                      RooAbsReal& _x,
                      RooAbsReal& _c0,
                      RooAbsReal& _c1,
...
public:
  RooErfPowExpPdf(){};
  RooErfPowExpPdf(const char* name,
                  const char* title,
                  RooAbsReal& _x,
                  RooAbsReal& _c0,
                  RooAbsReal& _c1,
...
public:
  ...
  RooAlpha4ErfPowExpPdf(const char* name,
                        const char* title,
                        RooAbsReal& _x,
                        RooAbsReal& _c0,
                        RooAbsReal& _c1,
...
public:
  RooAlpha4GausExpPdf(){};
  RooAlpha4GausExpPdf(const char* name,
                      const char* title,
                      RooAbsReal& _x,
                      RooAbsReal& _c,
                      RooAbsReal& _mean,
...
public:
  RooAlpha4ErfPowPdf(){};
  RooAlpha4ErfPowPdf(const char* name,
                     const char* title,
                     RooAbsReal& _x,
                     RooAbsReal& _c,
                     RooAbsReal& _offset,
...
public:
  RooPow2Pdf(){};
  RooPow2Pdf(const char* name, const char* title, RooAbsReal& _x, RooAbsReal& _p0, RooAbsReal& _p1);
...
public:
  RooPowPdf(){};
  RooPowPdf(const char* name, const char* title, RooAbsReal& _x, RooAbsReal& _p0);
...
public:
  RooQCDPdf(){};
  RooQCDPdf(const char* name, const char* title, RooAbsReal& _x, RooAbsReal& _p0, RooAbsReal& _p1, RooAbsReal& _p2);
...
public:
  RooUser1Pdf(){};
  RooUser1Pdf(const char* name, const char* title, RooAbsReal& _x, RooAbsReal& _p0, RooAbsReal& _p1);
...
public:
  RooExpNPdf(){};
  RooExpNPdf(const char* name, const char* title, RooAbsReal& _x, RooAbsReal& _c, RooAbsReal& _n);
...
public:
  RooAlpha4ExpNPdf(){};
  RooAlpha4ExpNPdf(const char* name,
                   const char* title,
                   RooAbsReal& _x,
                   RooAbsReal& _c0,
                   RooAbsReal& _n0,
...
public:
  RooExpTailPdf(){};
  RooExpTailPdf(const char* name, const char* title, RooAbsReal& _x, RooAbsReal& _s, RooAbsReal& _a);
...
public:
  RooAlpha4ExpTailPdf(){};
  RooAlpha4ExpTailPdf(const char* name,
                      const char* title,
                      RooAbsReal& _x,
                      RooAbsReal& _s0,
                      RooAbsReal& _a0,
...
public:
  Roo2ExpPdf(){};
  Roo2ExpPdf(const char* name, const char* title, RooAbsReal& _x, RooAbsReal& _c0, RooAbsReal& _c1, RooAbsReal& _frac);
...
public:
  RooAlpha42ExpPdf(){};
  RooAlpha42ExpPdf(const char* name,
                   const char* title,
                   RooAbsReal& _x,
                   RooAbsReal& _c00,
                   RooAbsReal& _c01,
...
public:
  RooAnaExpNPdf(){};
  RooAnaExpNPdf(const char* name, const char* title, RooAbsReal& _x, RooAbsReal& _c, RooAbsReal& _n);
...
public:
  ...
  RooDoubleCrystalBall(const char* name,
                       const char* title,
                       RooAbsReal& _x,
                       RooAbsReal& _mean,
                       RooAbsReal& _width,
