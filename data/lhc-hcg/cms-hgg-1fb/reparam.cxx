void reparam(int ncat = 4, int crop = 0) {
  ...
  wAll->factory(
      "prod::CMS_hgg_sig_sigma_cat1(mgg_sig_sigma_cat1, CMS_hgg_sig_sigmaScaleEBEB, CMS_hgg_sig_sigmaScaleBadR9)");
  wAll->factory("prod::CMS_hgg_sig_sigma_cat2(mgg_sig_sigma_cat2, CMS_hgg_sig_sigmaScaleEEEX)");
  wAll->factory(
      "prod::CMS_hgg_sig_sigma_cat3(mgg_sig_sigma_cat3, CMS_hgg_sig_sigmaScaleEEEX, CMS_hgg_sig_sigmaScaleBadR9)");
  wAll->factory("prod::CMS_hgg_sig_gsigma_cat0(mgg_sig_gsigma_cat0, CMS_hgg_sig_sigmaScaleEBEB)");
  wAll->factory(
      "prod::CMS_hgg_sig_gsigma_cat1(mgg_sig_gsigma_cat1, CMS_hgg_sig_sigmaScaleEBEB, CMS_hgg_sig_sigmaScaleBadR9)");
  wAll->factory("prod::CMS_hgg_sig_gsigma_cat2(mgg_sig_gsigma_cat2, CMS_hgg_sig_sigmaScaleEEEX)");
  wAll->factory(
      "prod::CMS_hgg_sig_gsigma_cat3(mgg_sig_gsigma_cat3, CMS_hgg_sig_sigmaScaleEEEX, CMS_hgg_sig_sigmaScaleBadR9)");

  for (int c = 0; c < ncat; ++c) {
    wAll->factory(TString::Format(
        "CMS_hgg_bkg_slope_cat%d[%g]", c, wAll->var(TString::Format("mgg_bkg_slope_cat%d", c))->getVal()));
  }

  // (3) do reparametrization of signal
  for (int c = 0; c < ncat; ++c) {
    wAll->factory(TString::Format("EDIT::CMS_hgg_sig_cat%d(MggSig_cat%d,", c, c) +
    ...
    wAll->factory(TString::Format("EDIT::CMS_hgg_bkg_cat%d(MggBkg_cat%d,", c, c) +
