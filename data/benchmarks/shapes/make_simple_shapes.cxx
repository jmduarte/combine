void make_simple_shapes(int nS = 10, int nB = 100, int seed = 37) {
  ...
  wUPN->import(*bgpdf);
  wUPN->factory(
      "sum::param_alpha(-0.3,prod(alphaNorm[0],0.1))");  // param_alpha = -0.3 + 0.1*alphaNorm, so Gauss(-0.3,1)
