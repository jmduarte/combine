...
specs = {
    "YR4 SM 7TeV": {"rows": (6, 43), "groups": xsecGroups},
    "YR4 SM 8TeV": {"rows": (6, 43), "groups": xsecGroups},
    "YR4 SM 13TeV": {"rows": (6, 43), "groups": xsecGroups},
    "YR4 SM 14TeV": {"rows": (6, 43), "groups": xsecGroups},
    "YR4 BSM 7TeV": {"rows": (6, 119), "groups": xsecGroupsBSM},
    "YR4 BSM 8TeV": {"rows": (6, 119), "groups": xsecGroupsBSM},
    "YR4 BSM 13TeV": {"rows": (6, 119), "groups": xsecGroupsBSM},
    "YR4 BSM 14TeV": {"rows": (6, 119), "groups": xsecGroupsBSM},
    "YR4 SM BR": {
        "rows": (7, 44),
        "groups": {
            "BR1": {
...
if __name__ == "__main__":
    ...
    parser.add_option("-l", "--log", default="INFO", metavar="LEVEL", help="Set the minimum logging level.")
