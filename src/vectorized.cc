...
void vectorized::mul_add(const uint32_t size,
                         double coeff,
...
void vectorized::mul_add_sqr(const uint32_t size,
                             double coeff,
                             double const* __restrict__ iarray,
                             double* __restrict__ oarray) {
  for (uint32_t i = 0; i < size; ++i) {
...
double vectorized::nll_reduce(const uint32_t size,
                              double* __restrict__ pdfvals,
                              double const* __restrict__ weights,
                              double sumcoeff,
                              double* __restrict__ workingArea) {
...
void vectorized::gaussians(const uint32_t size,
                           double mean,
                           double sigma,
                           double norm,
                           const double* __restrict__ xvals,
                           double* __restrict__ out,
                           double* __restrict__ workingArea,
                           double* __restrict__ workingArea2) {
...
void vectorized::exponentials(const uint32_t size,
                              double lambda,
                              double norm,
                              const double* __restrict__ xvals,
                              double* __restrict__ out,
...
void vectorized::powers(const uint32_t size,
                        double exponent,
                        double norm,
                        const double* __restrict__ xvals,
                        double* __restrict__ out,
