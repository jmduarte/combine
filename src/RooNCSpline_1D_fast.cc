...
RooNCSplineCore::T RooNCSpline_1D_fast::interpolateFcn(Int_t code, const char* rangeName) const {
  ...
  if (verbosity == RooNCSplineCore::kVerbose)
    cout << "combine/RooNCSpline_1D_fast(" << GetName() << ")::interpolateFcn begin with code: " << code << endl;
...
Double_t RooNCSpline_1D_fast::evaluate() const {
  ...
  if (verbosity == RooNCSplineCore::kVerbose) {
    cout << "combine/RooNCSpline_1D_fast(" << GetName() << ")::evaluate = " << value << " at x = " << theXVar << endl;
    RooArgSet Xdeps;
...
Double_t RooNCSpline_1D_fast::analyticalIntegral(Int_t code, const char* rangeName) const {
  ...
  if (verbosity == RooNCSplineCore::kVerbose) {
    cout << "combine/RooNCSpline_1D_fast(" << GetName() << ")::analyticalIntegral = " << value << " for code = " << code
         << endl;
  }
  return value;
}
