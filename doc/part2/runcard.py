...
DC.systs = [
    ("lumi", False, "lnN", [], {"bin1": {"qqWW": 0.0, "ggWW": 1.11, "ggH": 1.11, "others": 0.0}}),
    ("xs_ggH", False, "lnN", [], {"bin1": {"qqWW": 0.0, "ggWW": 0.0, "ggH": 1.16, "others": 0.0}}),
    ("WW_norm", False, "gmN", [4], {"bin1": {"qqWW": 0.16, "ggWW": 0.0, "ggH": 0.0, "others": 0.0}}),
    ("xs_ggWW", False, "lnN", [], {"bin1": {"qqWW": 0.0, "ggWW": 1.5, "ggH": 0.0, "others": 0.0}}),
    ("bg_others", False, "lnN", [], {"bin1": {"qqWW": 0.0, "ggWW": 0.0, "ggH": 0.0, "others": 1.3}}),
]  # <type 'list'>
